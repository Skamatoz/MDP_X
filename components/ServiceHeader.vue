...
<template>
    ...
    <section class=" flex-none h-12 justify-between items-center mb-2 hidden">
        <div class="flex gap-5 items-center">
            <span><h1 class="hidden sm:block text-3xl">Service</h1></span>
    ...
    <!-- <section class=" flex flex-wrap w-fit h-fit  rounded gap-2 mb-2 ">
           <NuxtLink to="/client/all" ><button :class="[ activeTab==='all' ? ' bg-gray-100 text-gray-900 font-medium' : '' ]" class="h-12 text-gray-600 border border-gray-100 px-10 rounded-xl hover:bg-gray-100 cursor-pointer">All Service</button></NuxtLink>
