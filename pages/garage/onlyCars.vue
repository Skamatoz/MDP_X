                ...
                <table class="min-w-full bg-white divide-y divide-gray-200 mb-20">
                  ...
                  <thead class="bg-gray-50">
                    <tr>
                      ...
                      <!-- <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Дата</th> -->
                    </tr>
                  </thead>
...
const { data, pending, error, refresh } = await useFetch(`${config.public.apiBase}/api/garage/onlycars`, {
